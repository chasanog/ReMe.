                                ...
                                ScrollView {
                                    if #available(iOS 14.0, *) {
                                        ...
                                        TextField(self.remiCellVM.remi.remiDescription, text: self.$remiCellVM.remi.remiDescription)
                                            ...
                                            .foregroundColor(.black)
                                            .multilineTextAlignment(.center)
                                            .frame(width: geometry.size.width * 0.8, height: geometry.size.height * 0.40)
                                    }
...
//                                    .onReceive(Publishers.keyboardHeight) { self.keyboardHeight = $0}.animation(.easeInOut(duration: 0.3))
                        ...
                        HStack(alignment: .center) {
                            VStack(alignment: .center) {
                                TextField(String(self.remiCellVM.remi.count), value: self.$remiCellVM.remi.count, formatter: NumberFormatter())
        //                            .bold()
